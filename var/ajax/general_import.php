	...
	foreach($update_this as $char) {
		foreach($data['members'] as $members) {
			if($members['character']['name'] == $char) {
				...
				$general_table = "CREATE TABLE IF NOT EXISTS `" .$guild_id['id']. "_" .$fetch_char_id['id']. "_general` (`id` int(11) NOT NULL AUTO_INCREMENT, `ilvl_on` mediumint(4) NOT NULL, `ilvl_off` mediumint(4) NOT NULL, `alvl` smallint(2) NOT NULL, `ak` smallint(2) NOT NULL, `ap` int(10) NOT NULL, `m2` smallint(4) NOT NULL, `m5` smallint(4) NOT NULL, `m10` smallint(4) NOT NULL, `m15` smallint(4) NOT NULL, `m_achv` smallint(2) NOT NULL, `wq` mediumint(5) NOT NULL, `rep_nightfallen` int(6) NOT NULL, `rep_valarjar` int(6) NOT NULL, `rep_wardens` int(6) NOT NULL, `rep_farondis` int(6) NOT NULL, `rep_highmountain` int(6) NOT NULL, `rep_dreamweaver` int(6) NOT NULL, `rep_legionfall` int(6) NOT NULL, UNIQUE KEY `id` (`id`)) ENGINE=MyISAM DEFAULT CHARSET=latin1 COLLATE=latin1_german2_ci AUTO_INCREMENT=1 ;";
				
				$raid_1_table = "CREATE TABLE IF NOT EXISTS `" .$guild_id['id']. "_" .$fetch_char_id['id']. "_raid_1` (`id` int(11) NOT NULL AUTO_INCREMENT, `name` varchar(32) COLLATE latin1_german2_ci NOT NULL, `lfr` mediumint(5) NOT NULL, `normal` mediumint(5) NOT NULL, `heroic` mediumint(5) NOT NULL, `mythic` mediumint(5) NOT NULL, PRIMARY KEY (`id`)) ENGINE=MyISAM  DEFAULT CHARSET=latin1 COLLATE=latin1_german2_ci AUTO_INCREMENT=2 ;";
								
				$raid_2_table = "CREATE TABLE IF NOT EXISTS `" .$guild_id['id']. "_" .$fetch_char_id['id']. "_raid_2` (`id` int(11) NOT NULL AUTO_INCREMENT, `name` varchar(32) COLLATE latin1_german2_ci NOT NULL, `lfr` mediumint(5) NOT NULL, `normal` mediumint(5) NOT NULL, `heroic` mediumint(5) NOT NULL, `mythic` mediumint(5) NOT NULL, PRIMARY KEY (`id`)) ENGINE=MyISAM  DEFAULT CHARSET=latin1 COLLATE=latin1_german2_ci AUTO_INCREMENT=2 ;";
				
				$raid_3_table = "CREATE TABLE IF NOT EXISTS `" .$guild_id['id']. "_" .$fetch_char_id['id']. "_raid_3` (`id` int(11) NOT NULL AUTO_INCREMENT, `name` varchar(32) COLLATE latin1_german2_ci NOT NULL, `lfr` mediumint(5) NOT NULL, `normal` mediumint(5) NOT NULL, `heroic` mediumint(5) NOT NULL, `mythic` mediumint(5) NOT NULL, PRIMARY KEY (`id`)) ENGINE=MyISAM  DEFAULT CHARSET=latin1 COLLATE=latin1_german2_ci AUTO_INCREMENT=2 ;";
				
				#$raid_4_table = "CREATE TABLE IF NOT EXISTS `" .$guild_id['id']. "_" .$fetch_char_id['id']. "_raid_4` (`id` int(11) NOT NULL AUTO_INCREMENT, `name` varchar(32) COLLATE latin1_german2_ci NOT NULL, `lfr` mediumint(5) NOT NULL, `normal` mediumint(5) NOT NULL, `heroic` mediumint(5) NOT NULL, `mythic` mediumint(5) NOT NULL, PRIMARY KEY (`id`)) ENGINE=MyISAM  DEFAULT CHARSET=latin1 COLLATE=latin1_german2_ci AUTO_INCREMENT=2 ;";
				...
				#$tos_boss = array("Goroth", "Demonc Inquisition", "Harjatan the Bludger", "Mistress Sassz'ine", "Sisters of the Moon", "The Desolate Hoste", "Maiden of Vigilance", "Fallen Avatar", "Kil'jaeden");
