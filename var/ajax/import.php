	...
	if ( $data != '' ) {
		...
		if ( $escaped_session_guild_name == $escaped_source_guild_name ) {
			...
			if ( $data[ 'level' ] == '110' ) {
				...
				$general_table = mysqli_query( $stream, "INSERT INTO `" . $guild_id[ 'id' ] . "_" . $fetch_char_id[ 'id' ] . "_general` (`ilvl_on`, `ilvl_off`, `alvl`, `ak`, `ap`, `m2`, `m5`, `m10`, `m15`, `m_achv`, `wq`, `rep_nightfallen`, `rep_valarjar`, `rep_wardens`, `rep_farondis`, `rep_highmountain`, `rep_dreamweaver`, `rep_legionfall`) VALUES ('" . $ilvlaverage . "', '" . $ilvlaveragebags . "', '" . $artifact_level . "', '" . $artifact_knowledge . "', '" . $artifact_power . "', '" . $mythic_plus2 . "', '" . $mythic_plus5 . "', '" . $mythic_plus10 . "', '" . $mythic_plus15 . "', '" . $mplus . "', '" . $world_quests . "', '" . $rep_suramar . "', '" . $rep_stormheim . "', '" . $rep_wardens . "', '" . $rep_azsuna . "', '" . $rep_highmountain . "', '" . $rep_valsharah . "', '" . $rep_legionfall . "');" );
				...
				foreach ( $items as $id => $item ) {
					$insert = mysqli_query( $stream, "INSERT INTO `" . $guild_id[ 'id' ] . "_" . $fetch_char_id[ 'id' ] . "_equip` (`id`, `itemid`, `itemlevel`, `bonus`, `enchant`, `gem`) VALUES ('" . $id . "', '" . $ {
						'' . $item . '_id'
					} . "', '" . $ {
						'' . $item . '_ilvl'
					} . "', '" . $ {
