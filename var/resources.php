...
<div style="width: 60%; height: auto; float: left; text-align: center; background-color: #84724E; box-shadow: 0px 10px 35px 10px rgba(0,0,0,0.5); -moz-box-shadow: 0px 10px 35px 10px rgba(0,0,0,0.5); -webkit-box-shadow: 0px 10px 35px 10px rgba(0,0,0,0.5); margin-top: 15px; margin-left: 20%;">	
	...
	<table style="width: 100%;">
		<tbody>
			...
			<tr>
				<td><a href="http://www.wowhead.com/tooltips" title="Wowhead Tooltips">Wowhead Tooltip JS</a></td>
			</tr>
			<tr>
			...
			<tr>
				<td><a href="http://raidbots.com/" title="Raidbots.com - cloud simcrafting">Raidbots.com API</a>
			</tr>
			<tr>
				<td><a href="https://github.com/simulationcraft/simc/wiki" title="Github SimulationCraft documentation">SimulationCraft documentation</a>
			</tr>
			<tr>
