...
$itemlevels = mysqli_fetch_array(mysqli_query($stream, "SELECT `ilvl_on`, `ilvl_off` FROM `" .$_SESSION['table']. "_" .$_GET['source']. "_general`"));
...
$weapon = mysqli_fetch_array(mysqli_query($stream, "SELECT * FROM `" .$_SESSION['table']. "_" .$_GET['source']. "_weapons`"));
	
foreach($slots as $id => $slot) {
	$item_info = mysqli_fetch_array(mysqli_query($stream, "SELECT * FROM `" .$_SESSION['table']. "_" .$_GET['source']. "_equip` WHERE `id` = '" .$id. "'"));
...
$sum = array();
for($i = '1'; $i <= '13'; $i++) {
	$dungeon_stats = mysqli_fetch_array(mysqli_query($stream, "SELECT * FROM `" .$_SESSION['table']. "_" .$_GET['source']. "_dungeons` WHERE `id` = '" .$i. "'"));
...
$m_plus_overview = mysqli_fetch_array(mysqli_query($stream, "SELECT `m2`, `m5`, `m10`, `m15` FROM `" .$_SESSION['table']. "_" .$_GET['source']. "_general`"));
...
echo '<script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
	...
	function drawStacked() {
		...
		var chart = new google.visualization.BarChart(document.getElementById("source"));
		chart.draw(data, options);
	}
	</script>

	<div id="source" style="width: 740px; height: 137px; margin: 0 auto;"></div>';
...
$en_names = mysqli_query($stream, "SELECT `name` FROM `" .$_SESSION['table']. "_" .$_GET['source']. "_raid_1`");
...
for($i = '1'; $i <= '7'; $i++) {
	$kills = mysqli_fetch_array(mysqli_query($stream, "SELECT * FROM `" .$_SESSION['table']. "_" .$_GET['source']. "_raid_1` WHERE `id` = '" .$i. "'"));
...
$tov_names = mysqli_query($stream, "SELECT `name` FROM `" .$_SESSION['table']. "_" .$_GET['source']. "_raid_2`");
...
for($i = '1'; $i <= '3'; $i++) {
	$kills = mysqli_fetch_array(mysqli_query($stream, "SELECT * FROM `" .$_SESSION['table']. "_" .$_GET['source']. "_raid_2` WHERE `id` = '" .$i. "'"));	
...
$nh_names = mysqli_query($stream, "SELECT `name` FROM `" .$_SESSION['table']. "_" .$_GET['source']. "_raid_3`");
...
for($i = '1'; $i <= '10'; $i++) {
	$kills = mysqli_fetch_array(mysqli_query($stream, "SELECT * FROM `" .$_SESSION['table']. "_" .$_GET['source']. "_raid_3` WHERE `id` = '" .$i. "'"));
...
$tos_names = mysqli_query($stream, "SELECT `name` FROM `" .$_SESSION['table']. "_" .$_GET['source']. "_raid_4`");
...
for($i = '1'; $i <= '9'; $i++) {
	$kills = mysqli_fetch_array(mysqli_query($stream, "SELECT * FROM `" .$_SESSION['table']. "_" .$_GET['source']. "_raid_4` WHERE `id` = '" .$i. "'"));
