...
foreach($_GET as $user_id) {
	...
	echo '<div id="' .$user_id. '" style="width: 21.25%; height: auto; padding-top: 15px; padding-bottom: 15px; float: left; background-color: #84724E; box-shadow: 0px 10px 35px 10px rgba(0,0,0,0.5); -moz-box-shadow: 0px 10px 35px 10px rgba(0,0,0,0.5); -webkit-box-shadow: 0px 10px 35px 10px rgba(0,0,0,0.5); margin-top: 15px; ' .$margin_left. '">';
	...
	echo '<span style="font-size: 18px;"><a href="http://' .$_SESSION['region']. '.battle.net/wow/en/character/' .$_SESSION['realm']. '/' .$general_char_data['name']. '/simple" title="WoW Armory link">' .$general_char_data['name']. '</a> - 
	...
	echo '</tr>
	<tr style="background-color: #84724E;">
	...
	<thead>
	<tr>
		<th><span title="Court of Farondis">Azs</span></th>
		<th><span title="Legionfall">BrS</span></th>	
		<th><span title="Highmountain Tribe">HiM</span></th>
		<th><span title="The Valarjar">Sto</span></th>	
	</tr>
	</thead>
	<tbody>
	<tr>';
		
	$reputation_array = array($general_table['rep_farondis'], $general_table['rep_legionfall'], $general_table['rep_highmountain'], $general_table['rep_valarjar']);
	...
	foreach($reputation_array as $faction) {
		...
		elseif($faction < '3000') {
			$rep = '<span style="color: yellow;" title="' .$faction. '">Neutral/worse</span>';
		}
	...
	echo '</tr>
	<tr style="background-color: #84724E;">
		<th><span title="The Nightfallen">Sur</span></th>
		<th><span title="Dreamweavers">Val</span></th>
		<th><span title="The Wardens">War</span></th>
	</tr>';
	
	$reputation_array = array($general_table['rep_nightfallen'], $general_table['rep_dreamweaver'], $general_table['rep_wardens']);
	...
	<p style="font-size: 18px; color: yellowgreen;">Emerald Nightmare</p>
	<table style="margin: 0 auto; text-align: center; margin-top: 15px; width: 90%;">
	<thead>
		<tr>
	...
	<p style="font-size: 18px; color: yellowgreen;">Trial of Valor</p>
	<table style="margin: 0 auto; text-align: center; margin-top: 15px; width: 90%;">
	<thead>
		<tr>
			<th title="Odyn">O</th>
	...
	<p style="font-size: 18px; color: yellowgreen;">The Nighthold</p>
	<table style="margin: 0 auto; text-align: center; margin-top: 15px; width: 90%;">
	<thead>
		<tr>
	...
	echo '<tr style="background-color: #84724E;">
	...
	<p style="font-size: 18px; color: yellowgreen;">Tomb of Sargeras</p>
	<table style="margin: 0 auto; text-align: center; margin-top: 15px; width: 90%;">
	<thead>
		<tr>
