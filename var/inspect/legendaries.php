...
$exists = mysqli_num_rows(mysqli_query($stream, "SELECT * FROM `" .$_SESSION['table']. "_" .$_GET['inspect']. "_legendaries`"));
...
if($exists != '') {
	...
	echo '<tr><td>This character does not seem to have a legendary equipped.</td>';
}
