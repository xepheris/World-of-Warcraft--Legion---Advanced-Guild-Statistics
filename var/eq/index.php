...
$array = array( 'Itemlevel',
	...
	'Artifact Knowledge',
	'Artifact Level',
	'every boss kill on lfr for each raid',
	'every boss kill on normal for each raid',
	'every boss kill on heroic for each raid',
	'every boss kill on mythic for each raid' );
...
$array = array( 'time needed to complete a world quest: 150 seconds (2.5 minutes)',
	...
	'time needed to kill a lfr raid boss = 900 seconds * progression time = 900/2 = 450 seconds (7.5 minutes)',		   
	'time needed to kill a normal raid boss = 900 seconds * progression time = 900*1 = 900 seconds (15 minutes)',
...
$array = array( 'worldquest' => '1',
	...
	'EN lfr raid boss kill' => '' .$eq_weights['en_lfr']. '',		   
	'EN normal raid boss kill' => '' .$eq_weights['en_n']. '',
	'EN heroic raid boss kill' => '' .$eq_weights['en_hc']. '',		   
	'EN mythic raid boss kill' => '' .$eq_weights['en_m']. '',
	'ToV lfr raid boss kill' => '' .$eq_weights['tov_lfr']. '',
	'ToV normal raid boss kill' => '' .$eq_weights['tov_n']. '',		   
	'ToV heroic raid boss kill' => '' .$eq_weights['tov_hc']. '',
	'ToV mythic raid boss kill' => '' .$eq_weights['tov_m']. '',
	'NH lfr raid boss kill' => '' .$eq_weights['nh_lfr']. '',
	'NH normal raid boss kill' => '' .$eq_weights['nh_n']. '',		   
	'NH heroic raid boss kill' => '' .$eq_weights['nh_hc']. '',
	'NH mythic raid boss kill' => '' .$eq_weights['nh_m']. '',
	'ToS lfr raid boss kill' => '' .$eq_weights['tos_lfr']. '',
	'ToS normal raid boss kill' => '' .$eq_weights['tos_n']. '',		   
