...
$contact = "return confirm('If you wish to contact me, either use the contact form when logged in or write me a mail to: ags [AT] gerritalex [DOT] de')";
...
if ( isset( $_POST[ 'gname' ] ) && isset( $_POST[ 'region' ] ) && isset( $_POST[ 'realm' ] ) && isset( $_POST[ 'pw' ] ) ) {
	...
	if ( strlen( $_POST[ 'pw' ] ) <= '2' ) {
		$password_fail = '<br /><span style="color: coral; text-align: center;">Please choose a password longer than 3 characters.</span>';
	} else {
...
<head>
	...
	<meta name="description" content="Advanced Guild Statistics combines all necessary utilities a raid leader or loot council needs to make roster or loot decisions" />
	<meta name="keywords" lang="en" content="world of warcraft, legion, guild, raid, heroic, mythic, progress, mythic plus, mythic+" />
	<meta name="reply-to" content="admin@gerritalex.de">
	<meta name="distribution" content="global">
	<meta name="revisit-after" content="7 days">
	<meta name="page-topic" content="guild and loot council decision making helper">
...
if ( isset( $_SESSION[ 'shortlink' ] ) ) {
	...
	$share = "return confirm('Share this link: http://ags.gerritalex.de/?sl=" . $_SESSION[ 'shortlink' ] . $current_share . "')";
